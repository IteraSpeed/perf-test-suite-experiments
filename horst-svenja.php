        ...
        <div class="container">
            ...
            <div class="navbar-header">
                <button class="navbar-toggle collapsed" type="button" data-toggle="collapse" data-target=".bs-navbar-collapse">
                    ...
                    <img data-src="assets-cache-and-compression-disabled/images/icons/bars.png" />
                </button>
            ...
            <nav class="collapse navbar-collapse bs-navbar-collapse" role="navigation">
              ...
              <p class="navbar-text">index.php</p>
            </nav>
            <!-- /.navbar-collapse -->
        </div>
        <!-- /.container -->
                ...
                <div class="carousel-holder">
                    <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            ...
                            <div class="item">
                                <img class="slide-image" data-src="assets-cache-and-compression-disabled/images/boat-1170x400.jpeg" alt="">
                            </div>
                            <div class="item">
                                <img class="slide-image" data-src="assets-cache-and-compression-disabled/images/snow-1170x400.jpeg" alt="">
                            </div>
                            <div class="item">
                                <img class="slide-image" data-src="assets-cache-and-compression-disabled/images/beach-1170x400.jpeg" alt="">
                            </div>
                            <div class="item">
                                <img class="slide-image" data-src="assets-cache-and-compression-disabled/images/glass-building-1170x400.jpeg" alt="">
                            </div>
                        </div>
                ...
                <ul class="thumbnails">
                    <li class="col-md-3">
                        <div class="thumbnail" href="assets-cache-and-compression-disabled/images/rila.jpg">
                            <a href="javascript:;">
                                <img class="attachment-portfolio-full wp-post-image" width="600" height="400" alt="Rila mountain, Bulgaria" data-src="assets-cache-and-compression-disabled/images/rila_small.jpg">
                            </a>
                            <div class="caption">
                                <h4>
									<a href="javascript:;">
										<img class="icon-small" data-src="assets-cache-and-compression-disabled/images/icons/holiday-mountain.png" /> Rila mountain, Bulgaria
									</a>
								</h4>
                    ...
                    <li class="col-md-3">
                        <div class="thumbnail" href="assets-cache-and-compression-disabled/images/varna_panorama.jpeg">
                            <a href="javascript:;">
                                <img class="attachment-portfolio-full wp-post-image" width="600" height="400" alt="Varna" data-src="assets-cache-and-compression-disabled/images/varna.jpeg">
                            </a>
                            <div class="caption">
                                <h4>
									<a href="javascript:;">
										<img class="icon-small" data-src="assets-cache-and-compression-disabled/images/icons/holiday-town.png" />
										Varna, Bulgaria
									</a>
								</h4>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut mattis, lorem vitae volutpat luctus, lectus nisl suscipit sem, nec varius magna neque in dui. Nullam non leo id turpis hendrerit...</p>
                    ...
                    <li class="col-md-3">
                        <div class="thumbnail" href="assets-cache-and-compression-disabled/images/tsarevets.jpg">
                            <a href="javascript:;">
                                <img class="attachment-portfolio-full wp-post-image" width="600" height="400" alt="Tzarevets, Veliko Tarnvo, Bulgaria" data-src="assets-cache-and-compression-disabled/images/tsarevets_small.jpg">
                            </a>
                            <div class="caption">
                                <h4>
									<a href="javascript:;">
										<img class="icon-small" data-src="assets-cache-and-compression-disabled/images/icons/holiday-nature.png" /> Tzarevets, Veliko Tarnovo, Bulgaria
									</a>
								</h4>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut mattis, lorem vitae volutpat luctus, lectus nisl suscipit sem, nec varius magna neque in dui. Nullam non leo id turpis hendrerit...</p>
                            </div>
                    ...
                    <li class="col-md-3">
                        <div class="thumbnail" href="assets-cache-and-compression-disabled/images/london.jpeg">
                            <a href="javascript:;">
                                <img class="attachment-portfolio-full wp-post-image" width="600" height="400" alt="London" data-src="assets-cache-and-compression-disabled/images/london.jpeg">
                            </a>
                            <div class="caption">
                                <h4>
									<a href="javascript:;">
										<img class="icon-small" data-src="assets-cache-and-compression-disabled/images/icons/holiday-travel.png" /> London
									</a>
								</h4>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut mattis, lorem vitae volutpat luctus, lectus nisl suscipit sem, nec varius magna neque in dui. Nullam non leo id turpis hendrerit...</p>
                            </div>
